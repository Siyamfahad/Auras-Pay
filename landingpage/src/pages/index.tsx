...
export default function LandingPage() {
  return (
    <>
      {/* Meta Tags */}
      <Head>
        <title>AURAS Pay - Accept Crypto Payments with Ease</title>
        <meta name="description" content="Accept Solana payments for your business. Lightning-fast, non-custodial crypto payment gateway built for merchants. Start your free trial today." />
